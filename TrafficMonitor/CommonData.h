...
//通知消息
    ...
    // Adaptador de red predeterminado. Si está vacío, se usa "Automático (predeterminado de Windows)".
    // Si contiene el nombre de un adaptador, ese adaptador se usará como predeterminado.
    std::wstring default_adapter;
